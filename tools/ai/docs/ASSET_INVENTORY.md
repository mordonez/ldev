...
| Legacy shell installer | `tools/ai/legacy/install.sh` | Old bootstrap/update flow | No | Installs deprecated assets and old layout |
...
- `legacy/` is an archive for source material during migration. It is not part
