...
import {pageEvidenceSchema} from './inventory-page.schema.js';

const inventoryPageSiteRootJsonSchema = z.object({
  page: z.object({
...
const inventoryPageRegularJsonSchema = z.object({
  page: z.object({
...
const inventoryPageDisplayJsonSchema = z.object({
  page: z.object({
...
export const liferayInventoryPageJsonSchema = z.union([
  inventoryPageSiteRootJsonSchema,
  inventoryPageRegularJsonSchema,
  inventoryPageDisplayJsonSchema,
]);
