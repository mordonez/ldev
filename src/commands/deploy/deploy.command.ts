...
`);
  ...
  addOutputFormatOption(
    command
      .command('all')
      .description('Compile and deploy all modules for the current repo'),
  ).action(createFormattedAction(async (context) => runDeployAll(context.config, {
  ...
  ).action(createFormattedAction(async (context) => runDeployPrepare(context.config, {
        printer: context.printer,
  ...
  ).action(createFormattedArgumentAction(async (context, module: string) => runDeployModule(context.config, {
        module,
        printer: context.printer,
  ...
  ).action(createFormattedAction(async (context, options: {theme: string}) => runDeployTheme(context.config, {
        theme: options.theme,
        printer: context.printer,
  ...
  addOutputFormatOption(
    command
      .command('service')
      .description('Run Service Builder and restore tracked service.properties'),
  ).action(createFormattedAction(async (context) => runDeployService(context.config, {
        printer: context.printer,
  ...
  ).action(createFormattedAction(async (context, options: {clean?: boolean}) => runDeployCacheUpdate(context.config, {
