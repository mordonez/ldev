...
export function createEnvSetupCommand(options?: SharedCommandOptions): Command {
  return withOptionalHelpGroup(
    ...
    ).action(createFormattedAction(async (context, commandOptions) => runEnvSetup(context.config, {
...
export function createEnvStartCommand(options?: SharedCommandOptions): Command {
  return withOptionalHelpGroup(
    ...
    ).action(createFormattedAction(async (context, commandOptions) => runEnvStart(context.config, {
...
export function createEnvLogsCommand(options?: SharedCommandOptions): Command {
  return withOptionalHelpGroup(
    new Command('logs')
      ...
      .action(async (commandOptions) => withCommandContext(commandOptions, async (context) => {
