...
describe('dashboard client shell', () => {
  test('declares the Vite entrypoint for the Preact app', () => {
    const index = fs.readFileSync('src/entrypoints/dashboard/client/index.html', 'utf8');
    const favicon = fs.readFileSync('src/entrypoints/dashboard/client/favicon.svg', 'utf8');
